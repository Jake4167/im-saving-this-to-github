...
## agent_communication:
    ...
    - agent: "main"
    - message: "TERRORIST ACCUSATIONS EVENT UPDATED: Enhanced Event #42 'Toast starts accusing everybody of being terrorists' with actual character names from the timeline. Toast now specifically targets Somnium (PRP founder), Rac (ISD), Gregnant (TPA), Medieval (UWP), TheLegendaryTaco (UWP), Russian Raven (PRP), The Old Cavalier (CL), and Heenheimsploot (DPGR) - all real characters from previous events. He builds conspiracy theories about their usernames and party affiliations, claiming Somnium's PRP founding was 'a cover operation' and Russian Raven's name 'screams foreign intelligence.' The paranoid delusions now target actual timeline participants, making Toast's breakdown feel more authentic to the Democratic Sim community."