export const mockEvents = [
  ...
  },
  {
    id: "37",
    date: "2025-08-20",
    title: "Toast deletes the discord server due to it getting too crazy",
    description: "Former President Toast (4th President), witnessing the complete breakdown of order in the Discord democratic simulation, deleted the entire Discord server, citing that the simulation had become 'too crazy' to continue.",
    category: "Crisis",
    parties: ["ISD", "Non-partisan"],
    type: "crisis",
    significance: "high",
    relatedEvents: ["18", "36", "33", "34", "35"],
    details: "On August 20, 2025, five days after the simulated public execution of President Sweet and Vice President Nepotism, former President Toast (Toast_toast123) made the ultimate decision to end the chaos once and for all. As the server owner and founder of the Democratic Simulation, Toast had watched in horror as his carefully crafted political experiment descended into complete madness. The roleplay had spiraled far beyond what anyone had intended, with users taking their political rivalries too seriously and the fictional violence becoming increasingly disturbing. After consulting with other moderators and longtime members, Toast made a lengthy announcement in the general chat: 'This has gotten way too crazy. The simulation was supposed to be fun political roleplay, but it's turned into something toxic and disturbing. When people are writing detailed descriptions of hanging the President and Vice President, complete with last words and public executions, we've crossed a line from political roleplay into something genuinely disturbing. The fact that some of you seemed to genuinely enjoy writing about the public execution of Sweet and Nepotism really bothers me. This was supposed to be about democracy, elections, and governance - not graphic violence and revenge fantasies. I'm pulling the plug.' Without further ceremony, Toast_toast123 exercised his ultimate authority as server owner and deleted the entire Democratic Sim Discord server at 11:47 PM EST. In an instant, months of political roleplay, character development, constitutional documents, election records, and legislative history vanished into the digital void. The 847 members who had participated in the simulation found themselves removed from the server, with only their memories and screenshots remaining of Julia's tumultuous political experiment. Some members tried to recreate the server or continue the roleplay elsewhere, but none recaptured the unique chemistry and chaos that had made the original Democratic Sim so compelling and ultimately so destructive. Toast later posted on his personal social media: 'Sometimes the best way to end a story is to just hit delete. The Democratic Sim was an amazing experiment in online political roleplay, but when fiction starts feeling too real and people get genuinely hurt by detailed execution fantasies, it's time to pull the plug. The hanging scene was the final straw - that wasn't political roleplay anymore, it was just disturbing. Thanks to everyone who participated in the good parts – it was wild while it lasted, but some lines shouldn't be crossed even in fiction.' With this simple but decisive action, the Democratic Simulation of Julia came to an abrupt and final end, leaving behind only the archived wiki pages as a testament to one of Discord's most dramatic political roleplay experiments."
  }
];
