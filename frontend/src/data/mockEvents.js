export const mockEvents = [
  ...
  },
  {
    id: "37",
    date: "2025-08-20",
    title: "Toast ends the democratic experiment of a nation due to it getting too crazy",
    description: "Former President Toast (4th President), witnessing the complete breakdown of democratic order and the descent into chaos, officially declared an end to Julia's democratic experiment, citing that the situation had become 'too crazy' to continue.",
    category: "Crisis",
    parties: ["ISD", "Non-partisan"],
    type: "crisis",
    significance: "high",
    relatedEvents: ["18", "36", "33", "34", "35"],
    details: "On August 20, 2025, five days after the public execution of President Sweet and Vice President Nepotism, former President Toast (Toast_toast123) emerged from hiding to make a historic declaration that would mark the official end of Julia's democratic experiment. Speaking from an undisclosed location via emergency broadcast, Toast - who had served as the 4th President for 42 days and was considered one of the most stable leaders in Julia's troubled history - announced that the democratic system had 'become too crazy to sustain.' In his 15-minute address to the nation, Toast catalogued the systematic failures: the assassination of all six former presidents, the Constitutional Purifier insurgency controlling vast territories, terrorist attacks on election infrastructure, the execution of sitting leaders, and the complete breakdown of institutional order. 'What we have witnessed,' Toast declared, 'is not democracy but a descent into madness. The experiment has failed not because democracy is weak, but because we allowed extremism to poison every institution we built.' Toast announced the formal dissolution of all remaining democratic institutions, declared martial law under emergency powers, and established a transitional military government to restore basic order. He emphasized that this was not a coup but a necessary step to prevent total societal collapse. The broadcast ended with Toast's somber words: 'History will judge whether we were brave enough to try democracy, or foolish enough to let it destroy us. Today, the Democratic Simulation of Julia officially ends. May future generations learn from our failures and build something better.' With this declaration, the Democratic Sim Wiki's chronicle of political chaos finally came to its conclusion, marking the end of one of the most turbulent and violent democratic experiments in simulated political history."
  }
];
