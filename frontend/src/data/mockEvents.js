export const mockEvents = [
  ...
  },
  {
    ...
    details: "On August 23, 2025, at 8:12 AM, Toast_toast123 began what would become known as the 'Great Terrorist Accusations' - a systematic campaign where he individually accused every active server member of being an actual terrorist. His paranoia had reached clinical levels as he posted: 'I've been thinking about this all night and I'm convinced half of you are real terrorists' 'Nobody knows this much about explosives by accident' 'Somnium - you described the exact chemical composition of PETN. That's not Google knowledge' 'Rac - you calculated blast radiuses with precision. Where did you learn that?' 'Gregnant - your insurgency tactics are too detailed. Military training?' 'Medieval - you wrote about assassination methods like you've studied them professionally' 'TheLegendaryTaco - tank specifications? Really? Just a hobby?' 'Russian Raven - your knowledge of government building layouts is suspicious' 'The Old Cavalier - you know too much about security protocols' 'Heenheimsploot - suspiciously quiet about your background' 'And Jash - OH MY GOD JASH IS THE WORST OF ALL!' 'JASH WAS LITERALLY PRESIDENT AND THEN GOT ASSASSINATED' 'THAT'S NOT A COINCIDENCE - THAT'S A DEEP STATE OPERATION' 'She probably faked her own death to go underground' 'Former presidents don't just casually hang around Discord servers' 'Unless they're running intelligence operations' 'Jash - your 50-day presidency was clearly a cover for infiltration' 'You gathered intel on government operations and then staged your assassination' 'The drone strike was way too convenient and sophisticated' 'WHO HAS ACCESS TO MILITARY DRONES, JASH?' 'You're probably posting from a CIA safe house right now' 'Building case files on each of you' 'Screenshot documentation of everything you've written' 'Cross-referencing with public records' 'Some of you have suspiciously clean social media profiles' 'Classic sleeper agent behavior' 'Somnium founding PRP was probably a cover operation' 'Rac's ISD connections run deeper than politics' 'Medieval's username is clearly a military reference' 'TheLegendaryTaco - what kind of taco expert knows about armor plating?' 'Russian Raven - the name literally screams foreign intelligence' 'But Jash is the smoking gun - FORMER PRESIDENTS DON'T JUST HANG OUT IN DISCORD SERVERS' 'Unless they're deep cover operatives' 'I'm reporting each of you individually to FBI, ATF, and Homeland Security' 'Your IP addresses, Discord IDs, any personal info I can find' 'This server is a terrorist cell recruitment operation' 'You're all on watchlists now' 'I'm going to make sure you're all investigated' 'Real background checks, real surveillance' 'You wanted to play with terrorist content? Now you get real terrorist investigations' 'Every single one of you is going to be questioned' 'Your computers searched, your phones monitored' 'You brought this on yourselves' 'Normal people don't write detailed bombing instructions' 'Normal people don't get excited about body counts' 'Normal people don't know military tactics' 'You're all sick freaks and probable terrorists' 'I'm done pretending this is just a game' 'This is real life now' 'Real consequences' 'Real investigations' 'Real watchlists' 'Enjoy explaining your 'hobby' to federal agents' The accusations continued for hours, with Toast systematically going through every server member, analyzing their posts, and building elaborate conspiracy theories about their 'real' identities and motivations. The server members were initially amused, then concerned, then genuinely frightened by the intensity of Toast's paranoid delusions and threat to involve federal authorities in what had been a creative writing exercise."
  },
