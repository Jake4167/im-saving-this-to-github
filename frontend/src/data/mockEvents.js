export const mockEvents = [
  ...
  },
  {
    ...
    significance: "high",
    relatedEvents: ["37", "36"],
    details: "On August 20, 2025, just two days after his measured concerns about server content, Toast_toast123 reached his absolute breaking point. What started as a rational discussion about content boundaries had devolved into fierce arguments in the chat, with some members mocking Toast's concerns and others posting even more extreme content in defiance. At 9:23 PM EST, Toast completely lost it and began flooding the #general channel with an epic meltdown that lasted over an hour: 'ARE YOU PEOPLE INSANE?!?!' 'I LITERALLY JUST ASKED FOR BASIC DECENCY' 'INSTEAD OF LISTENING YOU'RE MAKING IT WORSE' 'SOME OF YOU ARE LITERALLY LAUGHING AT DETAILED MURDER SCENES' 'THIS IS SICK AND I'M DONE WITH ALL OF YOU' 'I SPENT MONTHS BUILDING THIS COMMUNITY AND YOU'RE DESTROYING IT' 'FINE! IF YOU WANT TO BE PSYCHOPATHS THEN DO IT SOMEWHERE ELSE' 'I'M DELETING THIS ENTIRE SERVER IN 10 MINUTES' 'EVERYONE BETTER START DOWNLOADING WHATEVER THEY WANT TO KEEP' 'YOU DID THIS TO YOURSELVES' 'I NEVER WANT TO SEE ANY OF YOU AGAIN' The chat exploded with panic as members realized Toast was serious about deleting everything. People frantically started screenshotting conversations, downloading images, and begging Toast to reconsider. Some members who had been silent finally spoke up, apologizing and asking for another chance. Others continued to mock Toast even during his meltdown, calling him 'too sensitive' and 'unfit to run a server.' The most dramatic moment came when Toast posted: 'You know what the worst part is? I actually cared about this place. I thought we were building something special. A real community. Instead I created a place where people compete to write the most disturbing content possible. I'm a failure as a server owner and I'm ending this nightmare.' Toast's breakdown was so intense that even his critics began to feel uncomfortable, with the chat falling silent for the first time in server history. The countdown to deletion created unprecedented chaos as the entire Democratic Simulation community faced the possibility of losing everything they had built together."
  },
