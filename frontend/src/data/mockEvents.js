export const mockEvents = [
  ...
  },
  {
    id: "37",
    date: "2025-08-20",
    title: "Toast ends the democratic simulator due to it getting too crazy",
    description: "Former President Toast (4th President), witnessing the complete breakdown of order in the Discord democratic simulation, officially declared an end to the Democratic Sim experiment, citing that the simulation had become 'too crazy' to continue.",
    category: "Crisis",
    parties: ["ISD", "Non-partisan"],
    type: "crisis",
    significance: "high",
    relatedEvents: ["18", "36", "33", "34", "35"],
    details: "On August 20, 2025, five days after the simulated public execution of President Sweet and Vice President Nepotism, former President Toast (Toast_toast123) emerged to make a historic declaration that would mark the official end of the Discord Democratic Simulation. Speaking through a special announcement in the server, Toast - who had served as the 4th President for 42 days and was considered one of the most stable leaders in the simulation's troubled history - announced that the democratic simulation had 'become too crazy to sustain.' In his detailed message to the Discord community, Toast catalogued the systematic failures within the simulation: the roleplay assassination of all six former presidents, the Constitutional Purifier insurgency storyline controlling vast territories, terrorist attacks on election infrastructure, the execution of sitting leaders, and the complete breakdown of institutional order within the game. 'What we have witnessed,' Toast declared, 'is not democracy but a descent into madness. The simulation has failed not because democracy is weak, but because we allowed extremist roleplay to poison every institution we built.' Toast announced the formal dissolution of all remaining democratic institutions within the Discord server, declared an end to the political simulation, and established that the Democratic Sim experiment would be concluded. He emphasized that while this was just a Discord simulation, the lessons learned about extremism and institutional breakdown were valuable for understanding real-world politics. The announcement ended with Toast's somber words: 'History will judge whether we were brave enough to try this democratic simulation, or foolish enough to let fictional extremism destroy our experiment. Today, the Democratic Simulation of Julia officially ends. May future Discord political simulations learn from our failures and build something better.' With this declaration, the Democratic Sim Wiki's chronicle of simulated political chaos finally came to its conclusion, marking the end of one of the most turbulent and dramatic Discord political simulation experiments in online gaming history."
  }
];
