export const mockEvents = [
  ...
  },
  {
    id: "46",
    date: "2025-08-26",
    title: "Toast randomly explodes in another Jake harassment spree",
    description: "After a brief quiet period during the server-wide chaos, Toast_toast123 suddenly launches into another unprovoked tirade against Jake, posting hundreds of increasingly unhinged messages calling him a terrorist mastermind and demanding immediate action from law enforcement.",
    category: "Crisis",
    parties: ["Non-partisan"],
    type: "crisis",
    significance: "high",
    relatedEvents: ["45", "44", "43", "42"],
    details: "On August 26, 2025, at 11:23 AM, just as the server was attempting to recover from the previous day's mass hysteria, Toast_toast123 suddenly erupted in another explosive tirade specifically targeting Jake. Without any apparent trigger, Toast began flooding the chat with a relentless stream of accusations: 'JAKE! JAKE! JAKE!' 'I'VE BEEN THINKING ABOUT YOU ALL NIGHT AGAIN!' 'TERRORIST JAKE IS STILL HERE!' 'WHY HASN'T THE FBI ARRESTED TERRORIST JAKE YET?!' 'JAKE YOU FUCKING TERRORIST PIECE OF SHIT!' 'Look at him just sitting there acting innocent!' 'INNOCENT?! JAKE IS THE TERRORIST MASTERMIND!' 'Jake thinks he can just wait this out!' 'WRONG! I'M NEVER STOPPING!' 'TERRORIST JAKE! TERRORIST JAKE! TERRORIST JAKE!' 'Every second Jake remains free is another second of terrorist threat!' 'Jake is probably planning his next attack RIGHT NOW!' 'JAKE THE MARDONIA TERRORIST!' 'Jake the puppet master terrorist!' 'Jake the revenge terrorist!' 'Jake the Discord terrorist!' 'Jake the J-name terrorist!' 'EVERY TYPE OF TERRORIST IS JAKE!' 'I'm calling the police on TERRORIST JAKE!' 'I'm calling the FBI on TERRORIST JAKE!' 'I'm calling HOMELAND SECURITY on TERRORIST JAKE!' 'I'm calling INTERPOL on TERRORIST JAKE!' 'JAKE needs to be on every terrorist watchlist!' 'TERRORIST JAKE is an international threat!' 'Jake probably has terrorist cells in multiple countries!' 'MARDONIA WAS JUST THE BEGINNING!' 'Jake used Mardonia to recruit international terrorists!' 'Now he's expanding his terrorist network to Julia!' 'JAKE THE INTERNATIONAL TERRORIST!' 'Why is TERRORIST JAKE still allowed to post here?!' 'Ban TERRORIST JAKE immediately!' 'Arrest TERRORIST JAKE immediately!' 'Interrogate TERRORIST JAKE immediately!' 'TERRORIST JAKE is a clear and present danger!' 'Every minute we wait gives TERRORIST JAKE more time to plan!' 'JAKE! RESPOND TO THESE ACCUSATIONS!' 'DEFEND YOURSELF, TERRORIST JAKE!' 'Or are you too busy planning your next terrorist attack?!' 'TERRORIST JAKE probably has multiple backup plans!' 'TERRORIST JAKE probably has escape routes planned!' 'TERRORIST JAKE is always three steps ahead!' 'BUT I'M ON TO YOU, TERRORIST JAKE!' 'I SEE THROUGH YOUR TERRORIST SCHEMES!' 'YOUR TERRORIST CONSPIRACY IS EXPOSED!' 'TERRORIST JAKE! TERRORIST JAKE! TERRORIST JAKE!' The barrage continued for over two hours, with Toast posting Jake's name combined with 'terrorist' literally hundreds of times. Other server members, already traumatized from the previous days' chaos, watched in horror as Toast's obsession with Jake reached new levels of intensity. Some begged Toast to stop, others simply logged off, but Toast remained completely fixated on his target, treating Jake's mere presence in the server as an ongoing terrorist threat requiring immediate action."
  },
